...
################################################################################
# 建模数据
data_train = idx2numpy.convert_from_file("fashion-mnist-master/train-images-idx3-ubyte").reshape([60000, 784])
data_test= idx2numpy.convert_from_file("fashion-mnist-master/t10k-images-idx3-ubyte").reshape([10000, 784])
target_train = idx2numpy.convert_from_file("fashion-mnist-master/train-labels-idx1-ubyte")
target_test= idx2numpy.convert_from_file("fashion-mnist-master/t10k-labels-idx1-ubyte")
