...
################################################################################
# 定义基本变量
root_path = "CASIA-FaceV5/Face"
data_name = "CASIA-F5"
target = []
pixel_matrix = []
labels = ["{:03d}".format(i) for i in range(500)]
...
for cate in categories:
    ...
    files = [item for item in os.listdir(cate_path) if item.endswith(".bmp")]
    for file in files:
